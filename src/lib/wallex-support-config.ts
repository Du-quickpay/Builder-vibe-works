...
const WALLEX_TELEGRAM_SUPPORT =
  import.meta.env.VITE_WALLEX_TELEGRAM_SUPPORT || "https://t.me/WallexSupport";
...
export const validateWallexSupportConfig = (
  config: WallexSupportChatConfig,
): boolean => {
...
export const getWallexSupportFromEnv = (): WallexSupportChatConfig => {
  ...
  if (WALLEX_INTERCOM_ID && config.type === "intercom") {
    ...
    config.widgetScript =
      "https://widget.intercom.io/widget/" + WALLEX_INTERCOM_ID;
  }
